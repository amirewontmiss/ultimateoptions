...
with st.sidebar:
    ...
    st.write("`Created by: Amire Ramazan`")
    linkedin_url = "https://www.linkedin.com/in/ramazan-amire-41379521b/"
    st.markdown(f'<a href="{linkedin_url}" target="_blank" style="text-decoration: none; color: inherit;"><img src="https://cdn-icons-png.flaticon.com/512/174/174857.png" width="25" height="25" style="vertical-align: middle; margin-right: 10px;">`Amire Ramazan`</a>', unsafe_allow_html=True)
